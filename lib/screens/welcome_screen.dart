...
import 'package:myapp/screens/main_screen.dart'; // Importa MainScreen
...
class WelcomeScreen extends StatelessWidget {
  ...
  Widget _buildContent(BuildContext context, ColorScheme colorScheme) {
    final isDarkMode = Provider.of<ThemeProvider>(context, listen: false).isDarkMode(context);
        ...
        TextButton(
          onPressed: () {
            ...
            Navigator.pushReplacement(
              context,
              // Redirige a MainScreen, no a DashboardScreen
