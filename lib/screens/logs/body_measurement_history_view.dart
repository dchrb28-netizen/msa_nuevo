...
class BodyMeasurementHistoryView extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return ListView(
      ...
      children: [
        const Text('Historial de Mediciones', style: TextStyle(fontSize: 18, fontWeight: FontWeight.bold)),
  ...
  Widget _buildFullHistory() {
    return ValueListenableBuilder(
      ...
      builder: (context, Box<BodyMeasurement> box, _) {
        final allMeasurements = box.values.toList()..sort((a, b) => b.timestamp.compareTo(a.timestamp));
        ...
        final sortedDays = groupedMeasurements.keys.toList()..sort((a, b) => b.compareTo(a));
          ...
          itemBuilder: (context, index) {
            ...
            return Column(
              ...
              children: [
                ...
                ...measurementsForDay.map((measurement) => Card(
                    elevation: 2,
