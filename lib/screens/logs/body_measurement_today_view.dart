...
class BodyMeasurementTodayView extends StatefulWidget {
  const BodyMeasurementTodayView({super.key});

  @override
  State<BodyMeasurementTodayView> createState() => _BodyMeasurementTodayViewState();
}

class _BodyMeasurementTodayViewState extends State<BodyMeasurementTodayView> {
